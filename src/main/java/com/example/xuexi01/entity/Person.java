...
public class Person {
    ...
    public Person(int id, String name, Integer age, String sex, Date birthday, String telephone_number, String email, Timestamp onboarding_time, String post, int monthly_salary, int bonus, int sector_id) {
        this.id = id;
        this.name = name;
        this.age = age;
        this.sex = sex;
