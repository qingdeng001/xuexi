	...
	<div id="top_content">
		...
		<div id="content">
								...
								<script>
									function deleteEmployee(){
										if(window.confirm('确定要删除这条记录吗?')){
											location.href='${pageContext.request.contextPath}/person/delete?id=${Person.id}&sectorid=${sectorid}&nianling=${nianling}&xuanze=${xuanze}&neirong=${neirong}&permissions=${sessionScope.user.permissions}&pages=${pages}&uid=${uid}';
										}
									}
								</script>--%>
			...
			<p>
				...
				<input type="button" class="button" value="部门信息管理" onclick="window.location.href='${pageContext.request.contextPath}/sector/list03'">
			</p>
			<p>
