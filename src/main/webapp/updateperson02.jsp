...
<%--							<tr>
								...
								<td valign="middle" align="left">
									<input type="text" class="inputgri" name="sector_id" value="${person.sector_id}"/>
								</td>
							</tr>--%>
							<tr>
								<td valign="middle" align="right">
						...
						<p>
							<input type="button" class="button" value="返回" onclick="window.location.href='${pageContext.request.contextPath}/person/list?permissions=${sessionScope.user.permissions}'"/>
						</p>
					</form>
				</div>
			</div>
